...
pub struct Context {
    ...
    pub serial: &'static Mutex<ThreadModeRawMutex, BufferedUart<'static, UART1>>,
    pub baudrate: u32,
}
...
define_dispatch! {
    ...
    endpoints: {
        ...
        | SetBaudrate               | async     | set_baudrate_handler          |
        | GetBaudrate               | async     | get_baudrate_handler          |
    };
    ...
    topics_in: {
        ...
        | ----------                | ----      | -------                       |
        | UartSendTopic             | async     | send_uart_handler             |
    };
